...
import { TicketUserComponent } from './ticketuser.component';

describe('Ticket Management Component', () => {
  let comp: TicketUserComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(TicketUserComponent, '')
      .compileComponents();
    ...
    jest.spyOn(service, 'queryassign').mockReturnValue(
      of(
        new HttpResponse({
          body: [{ id: 123 }],
          headers,
